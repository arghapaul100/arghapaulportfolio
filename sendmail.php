<?php
		...
		if($search==1){
			...
			$mail->SMTPAuth = true;                               
			$mail->Username = 'mailserveraddress@gmail.com';  //mailserver address           
			$mail->Password = 'xxxxxxxxxxxx'; // mailserer password                         
			$mail->SMTPSecure = 'tls';                            
			$mail->Port = 587;  
			...
			$mail2->SMTPAuth = true;                               
			$mail2->Username = 'mailserveraddress@gmail.com'; //your gmail
			$mail2->Password = 'xxxxxxxxxxx'; //your gmail password                        
			...
			$mail2->addAddress($email, $name); //this will send the confirmation mail to recipents.
			...
			$mail2->Host = 'smtp.gmail.com'; 
			$mail2->SMTPAuth = true;                               
			$mail2->Username = 'yourgmail@gmail.com'; //your gmail
			$mail2->Password = 'xxxxxxxxxxx'; //your gmail password                        
			$mail2->SMTPSecure = 'tls';                            
			$mail2->Port = 587; 
